...
from stud_auth.views.allauth_custom import PasswordChangeView as PasswordChangeViewAllauth
...
# User Profile
    ...
    path('accounts/pass_change_allauth/', PasswordChangeViewAllauth.as_view(), name='pass_change_allauth'),
